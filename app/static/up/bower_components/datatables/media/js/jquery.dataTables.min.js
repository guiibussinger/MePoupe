...
JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primeira",sLast:"Anterior",sNext:"Próximo",sPrevious:"Último"},sEmptyTable:"Nenhuma informação disponível",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ resultados",sInfoEmpty:"Mostrando de 0 até 0 de 0 resultados",sInfoFiltered:"(busca feita com _MAX_ entradas)",
